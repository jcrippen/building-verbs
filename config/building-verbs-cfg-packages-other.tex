...
%% This adds more \write registers and a \FILEPREFIX.mw file.
%\usepackage{morewrites}

%% Microtypographic features.
%% Only turn this on for final drafts because it slows down compilation.
\usepackage[protrusion=true,expansion=false]{microtype}
% Some fonts trigger errors, so suppress protrusion for them.
\SetProtrusion{encoding = {TU}, family = AsanaMath}{}

%% Rotating objects.
%%
%% Supplies sidewaystable and sidewaysfigure environments.
\usepackage{rotating}

%% Multiple column environments.
%%
%% NOTE: This has nothing to do with multiple column spans in tables. That feature
%%   is obtained with \multicolumn{<count>}{<align>}{<text>} and is built into the
%%   tabular environment from memoir.
%%
...
%% Table of Contents for sections and chapters.
%%
%% The alternative package minitoc does not work very well with memoir.
%% See also:
%%   - http://tex.stackexchange.com/questions/50229/using-memoir-and-minitoc
%%   - http://tex.stackexchange.com/questions/62331/minitoc-per-sections-with-memoir
%%   - http://tex.stackexchange.com/questions/109904/appendix-with-titletoc-and-memoir
%%   - http://tex.stackexchange.com/questions/69247/mimic-memoir-toc-layout-in-titletoc-output
\usepackage{titletoc}