...
%%
%% Memoir configuration and document layout.
%%
...
%% Each page style is independent, but can be copied from others.
...
%%
%% Modifies \@dotsep. Value is in math units (mu) which are 1/18 em.
%% Standard value is 4.5.
\renewcommand{\cftdotsep}{9}

%% Width of page number box.
%%
%% Modifies \@pnumwidth. Standard value is 1.55em.
\setpnumwidth{2.5em}

%% Width of right margin, includes page number box.
%%
%% Modifies \@tocrmarg. Standard value is 2.55em.
\setrmarg{3.5em}

%% Width of boxes containing sectioning numbers.
%% These values were determined empirically.
%% FIXME: Automatically calculate from font metrics??
\setlength{\cftsectionnumwidth}{2.25em}
\setlength{\cftsubsectionnumwidth}{3.125em}
\setlength{\cftsubsubsectionnumwidth}{4em}
\setlength{\cftparagraphnumwidth}{4.5em}
\setlength{\cftsubparagraphnumwidth}{5.5em}
...
\setlength{\cftsubsectionindent}{2.25em}
\setlength{\cftsubsubsectionindent}{5.375em}
\setlength{\cftparagraphindent}{9.375em}
\setlength{\cftsubparagraphindent}{14em}
