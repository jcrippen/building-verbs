...
\footnote{Syncope is pronounced [\ipa{ˈsɪŋ.kə.pi}] and derives from Ancient Greek συγκοπή \fm{syŋkopḗ} ‘cutting up’. An English example of syncope is \fm{fasten} [\ipa{ˈfæ.sɛn}] + \fm{-er} → \fm{fastener} [\ipa{ˈfæ.sɛ.nəɹ}] syncopated to \fm{fast’ner} [\ipa{ˈfæs.nəɹ}].}
...
Some speakers dislike the form in (\ref{ex:args-obj-2sg-procl-syncope-without}), allowing only (\ref{ex:args-obj-2sg-procl-syncope-with}) or its equivalent \fm{ee msiteen} with \fm{m}.
